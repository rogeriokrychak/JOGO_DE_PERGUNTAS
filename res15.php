...
if($op=="SIM"){
  echo "Opção escolhida: $op, O seu animal é a TARTARUGA!!!!";
  echo "<br><br><img src='/images/tartaruga.png'>";
  echo "<br><br><a href='AtividadeII.html'><input type='Button' value='Voltar'></a>"; 
    ...
    echo "<h2>O seu animal é dos RÉPTEIS CARNÍVOROS?</h2>";
    echo "<form action='res16.php' method='post'>
